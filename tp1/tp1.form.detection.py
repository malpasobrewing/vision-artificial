...
def main():
    ...
    templates = [
        create_shape_from_image('Cuadrado', '../static/images/square.png'),
        create_shape_from_image('Triangulo', '../static/images/triangle.png'),
        create_shape_from_image('Circulo', '../static/images/circle.png'),
        create_shape_from_image('Estrella', '../static/images/star.png')
    ]
